 ...
 * Type: "greaterthanequal_placeholderapi"
 */
public class PlaceholderGTEFunction implements BadgeFunction {

    private final String placeholder;
    private final double value;

    public PlaceholderGTEFunction(String placeholder, double value) {
    ...
    public String getType() {
        return "greaterthanequal_placeholderapi";
    }
