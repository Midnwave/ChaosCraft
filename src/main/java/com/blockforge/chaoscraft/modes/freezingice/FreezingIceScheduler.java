...
public class FreezingIceScheduler {
    ...
    public FreezingIceScheduler(ChaosCraftPlugin plugin, AttackRegistry registry, FreezingIceConfig config) {
        this.plugin = plugin;
    ...
    public void forceSpawn(AbstractAttack attack, Player player) {
        ...
        plugin.debug("[FreezingIceScheduler] Force-spawned " + instance.getId() + " on " + player.getName());
    }
