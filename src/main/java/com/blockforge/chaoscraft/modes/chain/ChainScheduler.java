 ...
 * Mirrors FreezingIceScheduler — weighted random selection across BD / ENV / ME
 * attack types — no phase / escalation logic (Chain mode is flat-difficulty).
 */
public class ChainScheduler {
    ...
    public ChainScheduler(ChaosCraftPlugin plugin, AttackRegistry registry, ChainConfig config) {
        this.plugin = plugin;
    ...
    private void attemptSpawn() {
        ...
        plugin.debug("[ChainScheduler] Spawned " + attack.getId() + " (" + attack.getType()
