    ...
    public static class CatEyeGlare extends EnvironmentalAttack {
        ...
        @Override protected void onSpawn(Location center) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                h.scale(0.3f, 0.3f, 0.3f).glow(255, 255, 255).interpolation(40, 0);
                spawnedEntities.add(h.entity());
            }
            for (int i = 0; i < 2; i++) {
                ...
                h.scale(0.35f, 0.35f, 0.35f).glow(255, 100, 130).interpolation(40, 0);
                spawnedEntities.add(h.entity());
            }
        }
    ...
    public static class BigPawPrints extends EnvironmentalAttack {
        ...
        @Override protected void onSpawn(Location center) {
            ...
            for (int i = 0; i < 6; i++) {
                ...
                ItemDisplayHandle h = displayBuilder.spawnItem(p, new ItemStack(Material.STRING));
                h.scale(0.45f, 0.45f, 0.45f).glow(255, 220, 230).interpolation(40, 0);
                spawnedEntities.add(h.entity());
            }
            for (int i = 0; i < 4; i++) {
        ...
        @Override protected void onSpawn(Location center) {
            ...
            if (mag > 0.01) {
                ...
                for (int i = 0; i < 9; i++) {
                    ...
                    h.scale(0.45f, 0.45f, 0.45f).glow(255, 180, 220).interpolation(40, 0);
                    spawnedEntities.add(h.entity());
                }
                for (int i = 0; i < 6; i++) {
                    double t = (i + 0.5) / 6.0;
    ...
    public static class BabyMonsterReveal extends EnvironmentalAttack {
        ...
        @Override protected void onSpawn(Location center) {
            ...
            for (int side = -1; side <= 1; side += 2) {
                ...
                h.scale(0.3f, 0.3f, 0.3f).glow(255, 130, 180).interpolation(40, 0);
                spawnedEntities.add(h.entity());
            }
        }
    ...
    public static class CuddlePuddle extends EnvironmentalAttack {
        ...
        @Override protected void onSpawn(Location center) {
            ...
            for (int i = 0; i < 6; i++) {
                ...
                ItemDisplayHandle h = displayBuilder.spawnItem(p, new ItemStack(Material.STRING));
                h.scale(0.4f, 0.4f, 0.4f).glow(255, 220, 230).interpolation(40, 0);
                spawnedEntities.add(h.entity());
            }
            for (int i = 0; i < 4; i++) {
    ...
    public static class PlushFirework extends EnvironmentalAttack {
        ...
        @Override protected void onSpawn(Location center) {
            ...
            for (int i = 0; i < 6; i++) {
                ...
                h.scale(0.45f, 0.45f, 0.45f).glow(150, 150, 160).interpolation(40, 0);
                spawnedEntities.add(h.entity());
            }
            for (int i = 0; i < 6; i++) {
