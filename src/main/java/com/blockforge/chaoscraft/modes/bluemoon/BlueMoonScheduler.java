...
/**
 * Attack scheduler for Blue Moon Mode.
 * Supports both BLOCK_DISPLAY and ENVIRONMENTAL attack types.
 */
public class BlueMoonScheduler {
    ...
    public BlueMoonScheduler(ChaosCraftPlugin plugin, AttackRegistry registry, BlueMoonConfig config) {
        this.plugin = plugin;
    ...
    private void attemptSpawn() {
        ...
        plugin.debug("[BlueMoon] Spawned " + attack.getId() + " near " + target.getName()
    ...
    private World getBlueMoonWorld() {
